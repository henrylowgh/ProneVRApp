...
public class Atmo : MonoBehaviour 
{
	...
	public float m_hdrExposure = 0.5f;
	public Vector3 m_atmoColor = new Vector3(0.89f,0.82f,0.73f); // Wave length of sun light
	public float m_ESun = 1.0f; 			// Sun brightness constant
